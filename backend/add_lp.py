"""
Final addLiquidity for cbBTC/USDC LP
"""
...
print('\n--- Approving cbBTC ---')
send_tx(cbbtc.functions.approve(Web3.to_checksum_address(ROUTER), cbbtc_bal))

# Step 2: Approve USDC
print('\n--- Approving USDC ---')
send_tx(usdc.functions.approve(Web3.to_checksum_address(ROUTER), usdc_bal))

# Step 3: addLiquidity
print('\n--- Adding Liquidity ---')
slippage = 0.1  # 10% slippage for imbalanced position
